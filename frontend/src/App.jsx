      ...
      <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
          <div className="logo-container" style={{ margin: 0 }}>
            <img src="/logo.png" alt="Logo Neonato" className="app-logo" style={{ width: '80px' }} />
          </div>
          <div>
            <h1 style={{ marginBottom: '0.2rem', textAlign: 'left' }}>🏥 Expediente Neonatal</h1>
                  ...
                  <section>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '0.5rem' }}>
                      {selectedCaso.evaluaciones_apgar.map(a => (
                        <div key={a.id} style={{ padding: '10px', background: '#f8fafc', borderRadius: '8px' }}>
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '4px' }}>
                            <span style={{ fontWeight: 800, fontSize: '1rem' }}>Minuto {a.minuto}: {a.puntaje_total}/10</span>
                            <span className="result-badge badge-bien" style={{ margin: 0, padding: '2px 8px', fontSize: '0.65rem' }}>{a.clasificacion}</span>
                          </div>
